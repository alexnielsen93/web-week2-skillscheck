...
let faveColors =['silver', 'blue', 'gold']
//////////////////Step 2////////////////////
...
let me ={
  firstName:'Alex',
  superHeroName:'Alex the Average',
  homeTown: 'Lehi',
  superPowers: ['Irony', 'Napping', 'Average-ness'],
  superPowerXP(){
...
faveColors.splice(3)
  ...
  for (let i = 0; i < faveColors.length; i++ ){
    ...
    firstColor = faveColors[0];
    secondColor = faveColors[1];
    thirdColor = faveColors[2];
